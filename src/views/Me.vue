    ...
    <section class="aui-scrollView">
      ...
      <div class="aui-chang-list">
        <div class="aui-user-img">
          <img  style="width: 100%;height: 100%" :src="$store.state.user.userDetail.data.profile.avatarUrl" alt="">
        </div>
        <div class="aui-user-text">
          <h1>{{$store.state.user.userDetail.data.profile.nickname}}</h1>
          <span v-if="$store.state.user.userDetail.data.profile.vipType==0"><i class="icon icon-vip"></i>您还未开通VIP</span>
          <button>开通会员</button>
        </div>
